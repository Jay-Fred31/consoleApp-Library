...
const testModule = (function () {
  ...
  return {
    ...
    resetCounter: function () {
      console.log("The value of counter now is " + counter);
      counter = 0;
    },
  };
})();
...
// const nameSpacing = (function(){

//     // A private variable counter
//     let myPrivateCounter = 0;

//     // A private function that log a name
//     let myPrivateMethod = function(name){
...
//         myPublicVarible: "name",

//         // A public function using private properties
...
// console.log(nameSpacing.myPublicFunction('joyce'));
// console.log(nameSpacing.myPublicFunction('elizabeth'));
// console.log(nameSpacing.myPublicFunction("elizabeth"));


// const books = {
//     sience: ['biology', 'anthropology', 'physica'],
//     art: ['fine art', 'business', 'sugar'],
//     love: ['mayowa', 'tudonu', 'nunayon']
// };

// // convert object to keys array

// const science = Object.keys(books);

// // print all keys
// console.log(science);

// science.forEach((item, index) => {
//     console.log(`${index}: ${books[item][index]}`);
// });


// // access the values
// Object.values(books).forEach(book => console.log(book));
...
//     // get the size of the inner elements
//     let eachBookLength = books[i].length;
//     for(j = 0; j<eachBookLength; j++){
       
//         console.log(`${[j]}`+':'+books[i][j])
//     }
// }

// // science.forEach(book => {
// //     console.log(book);
